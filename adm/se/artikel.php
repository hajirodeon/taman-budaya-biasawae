...
if (($s == 'baru') OR ($s == 'edit'))
	...
	$(document).ready(function(){
	       ...
	       $('#image-holder').load("<?php echo $sumber;?>/adm/se/i_artikel.php?aksi=lihat1&kd=<?php echo $kd;?>");
			...
			$('#loading').show();
		     ...
		     $.ajax({
		      ...
		      success:function(data){
				$('#loading').hide();
		       $('#preview').load("<?php echo $sumber;?>/adm/se/i_artikel.php?aksi=lihat&kd=<?php echo $kd;?>");
