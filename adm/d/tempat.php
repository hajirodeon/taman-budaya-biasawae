...
//nilai
$filenya = "tempat.php";
$judul = "[MASTER] Data Tempat/Acara";
$judulku = "$judul";
$judulx = $judul;
$s = nosql($_REQUEST['s']);
...
if ($_POST['btnSMP'])
	...
	$e_kapasitas = cegah($_POST['e_kapasitas']);
...
if (($s == "baru") OR ($s == "edit"))
	...
	$e_kapasitas = balikin($rowx['kapasitas']);
	...
	<br>
	<input name="e_kapasitas" type="text" size="5" value="'.$e_kapasitas.'" class="btn btn-success">
	</p>
			...
			$('#loading').show();
		     ...
		     $.ajax({
		      ...
		      success:function(data){
				$('#loading').hide();
		       $('#preview').load("<?php echo $sumber;?>/adm/d/i_tempat.php?aksi=lihat&kd=<?php echo $kd;?>");
	...
	<div class="table-responsive">          
		  <table class="table" border="1">
		    <thead>
				...
				<td width="150"><strong><font color="'.$warnatext.'">KAPASITAS</font></strong></td>
	...
	if ($count != 0)
		...
		do {
			...
			$e_kapasitas = balikin($data['kapasitas']);
