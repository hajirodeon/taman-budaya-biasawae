...
$jml_tempat = mysqli_num_rows($qyuk);




//jml agenda
$qyuk = mysqli_query($koneksi, "SELECT * FROM cp_agenda");
$jml_agenda = mysqli_num_rows($qyuk);
...
//jml foto
$qyuk = mysqli_query($koneksi, "SELECT * FROM cp_g_foto");
$jml_foto = mysqli_num_rows($qyuk);
...
//jml booking
$qyuk = mysqli_query($koneksi, "SELECT * FROM sewa_tempat");
$jml_booking = mysqli_num_rows($qyuk);




//jml bukutamu
$qyuk = mysqli_query($koneksi, "SELECT * FROM cp_bukutamu");
$jml_bukutamu = mysqli_num_rows($qyuk);
  ...
  $(function () {
    ...
    areaChart.Line(areaChartData, areaChartOptions)
      ...
      <div class="row">
        ...
        <div class="col-md-4 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              <span class="info-box-text">TEMPAT/LOKASI</span>
              <span class="info-box-number"><?php echo $jml_tempat;?></span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
        ...
        <div class="col-md-4 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              ...
              <span class="info-box-number"><?php echo $jml_agenda;?></span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
        ...
        <div class="col-md-4 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              ...
              <span class="info-box-number"><?php echo $jml_booking;?></span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
        ...
        <div class="col-md-4 col-sm-6 col-xs-12">
          <div class="info-box">
            <span class="info-box-icon bg-orange"><i class="fa fa-pencil-square"></i></span>

            <div class="info-box-content">
              <span class="info-box-text">BUKU TAMU</span>
              <span class="info-box-number"><?php echo $jml_bukutamu;?></span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
