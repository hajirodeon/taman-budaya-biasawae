	...
	if (empty($e_nama))
		...
		if ($s == "baru")
			...
			*/
			...
			mysqli_query($koneksi, "INSERT INTO `cp_g_foto` (`kd`, `nama`, `filex`, `postdate`) ".
							"VALUES ('$e_kd', '$e_nama', '$namabaru', '$today');"); 
...
if (($s == "baru") OR ($s == "edit"))
	...
	<textarea id="e_nama" name="e_nama" rows="5" cols="80" style="width: 100%" class="btn-success">'.$e_nama.'</textarea>
